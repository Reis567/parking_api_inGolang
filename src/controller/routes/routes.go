...
func InitRoutes(
	...
	vehicleRoutes := r.Group("/veiculos")
	{
		vehicleRoutes.Use(middleware.AuthMiddleware())
		{
			...
			vehicleRoutes.GET("/ativos", veiculoController.FindVeiculosAtivos)
		}
	}
	...
	agendamentoRoutes := r.Group("/agendamentos")
	{
		agendamentoRoutes.Use(middleware.AuthMiddleware())
		{
			...
			agendamentoRoutes.GET("/reservas", agendamentoController.Reservas)
			agendamentoRoutes.POST("/cancelar/:id", agendamentoController.CancelAgendamento)
		}
	}
